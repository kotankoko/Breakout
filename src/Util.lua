...
-- This function is made to piece out powerup from the sprite sheet.
-- They are at the bottom of atlas at relatively easy to use location.
-- We just need to grab bottom row ignoring other parts of atlas altogether.
